...
public class DumpSQLService {
    ...
    public void dataBaseDump(String host, String port, String username, String password, String dbName, String currentDate) throws Exception {
        ...
        //备份成功，发送邮件
        sendEmailService.sendSimpleEmail(from,"2806987816@qq.com",currentDate+"数据备份",dbName+"备份数据库成功!");
    ...
    public void dump() throws Exception {
        ...
        dataBaseDump("localhost","3306","root","root","springbootdata",currentDate);
