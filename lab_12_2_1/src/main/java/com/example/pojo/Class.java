...
public class Class{
   ...
   public Class(Major major,Dept dept,Teacher tutor,Teacher instructor){
       ...
       this.tutorId=tutor.getJobId();
       this.instructorId=instructor.getJobId();
   }
    ...
    public String toString() {
        return "Class{" +
                ...
                ", bz='" + bz + '}'+
                /*", major=" + major +
                "\ndept={" + dept.getDeptId() +","+dept.getDeptId()+"}"+
                "\ntutor=" + tutor.getJobId() +tutor.getTeacherName()+"}"+
                "\ninstructor=" + instructor.getJobId() +instructor.getTeacherName()+"}"+*/
                '}';
    }
}