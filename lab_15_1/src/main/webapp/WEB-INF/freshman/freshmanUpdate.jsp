        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-10 col-lg-11 center-column">
                    <form action="freshmanUpdate" method="post" class="cmxform">
                        <%--				//2040706101 杨艾琳--%>
                        <div class="panel">
                            <div class="panel-heading">
                                <div class="panel-title">修改个人信息</div>
...
<%--                                    <div class="form-group">--%>
<%--                                        <div class="input-group"> <span class="input-group-addon">新生ID</span>--%>
<%--                                            <input type="text" readonly name="ticknumber" value="${freshman.ticketNumber}" class="form-control">--%>
<%--                                        </div>--%>
<%--                                    </div>--%>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group"> <span class="input-group-addon">性别</span>
                                            <input type="text" name="sex" value="${fresh.sex}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
