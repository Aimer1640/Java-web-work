...
//        String contextPath=request.getContextPath();
        return "redirect:/officer/findClassesByDept";
    }
//    //批量删除
//    @RequestMapping("/deleteClassByIds")
//    public String deleteClassByIds(String[] id){
//        int rows=classDao.deleteClassByIds(id);
////        String contextPath=request.getContextPath();
//        return "redirect:/officer/findClassesByDept";
//    }
...
//        c.setDeptId(407);
    ...
    public String findClassByClassId(@PathVariable("classId") int classId,Model model) {
        Class c=classDao.findClassById(classId);
        model.addAttribute("c",c);
        return "/officer/classUpdate";
//        return "redirect:/officer/showAllClasses";
    }
