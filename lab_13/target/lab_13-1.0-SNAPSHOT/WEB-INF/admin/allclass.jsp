  ...
  <aside id="sidebar" class="affix">
    ...
    <div id="sidebar-menu">
      <ul class="nav sidebar-nav">
        ...
        <li>
          <a href="allclass.jsp"><span class="glyphicons glyphicon-paperclip"></span><span class="sidebar-title">案例管理</span></a>
        </li>
        <li>
        ...
        <div class="col-md-12">
			<div class="panel">
                <div class="panel-heading">
                  ...
                  <a href="case_add.html" class="btn btn-info btn-gradient pull-right"><span class="glyphicons glyphicon-plus"></span> 添加案例</a>
                </div>
                ...
                <div class="panel-body">
                  <table class="table table-striped table-bordered table-hover dataTable">
                      <tr class="active">
                        ...
                        <td>
		                      <div class="btn-group">
		                        <a href="case_edit.html" class="btn btn-default btn-gradient"><span class="glyphicons glyphicon-pencil"></span></a>
