    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-10 col-lg-11 center-column">
          <form action="${basePath}/project/updateProject" method="post" class="cmxform">
            <div class="panel">
              <div class="panel-heading">
                <div class="panel-title">编辑作业</div>
                <div class="panel-btns pull-right margin-left">
                  <a href="${basePath}/project/findProjectByProjectId/" class="btn btn-default btn-gradient dropdown-toggle"><span class="glyphicon glyphicon-chevron-left"></span></a>
                </div>
              </div>
                ...
                <div class="col-md-7">
                  <div class="form-group">
                    <div class="input-group"> <span class="input-group-addon">作业ID</span>
                      <input type="text" readonly name="projectId" value="${p.projectId}" class="form-control">
                    </div>
                  </div>

                  <div class="form-group">
                    <div class="input-group"> <span class="input-group-addon">作业名称</span>
                      <input type="text" name="projectName" value="${p.projectName}" class="form-control">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group"> <span class="input-group-addon">作业要求</span>
                      <input type="text" name="projectDemand" value="${p.projectDemand}" class="form-control">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group"> <span class="input-group-addon">发布教师工号</span>
                      <input type="text" name="projectTeacher" value="${p.projectTeacher}" class="form-control">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group"> <span class="input-group-addon">作业状态</span>
                      <input type="text" name="projectState" value="${p.projectState}" class="form-control">
                    </div>
                  </div>

                  <div class="form-group">
                    <div class="input-group"> <span class="input-group-addon">作业文件</span>
                      <input type="text" name="projectFile" value="${p.projectFile}" class="form-control">
                      <div>
