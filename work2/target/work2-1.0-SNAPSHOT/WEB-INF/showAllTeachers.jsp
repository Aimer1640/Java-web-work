        ...
        <div class="am-fr" style="width: 180px;">
          <div class="am-input-group am-input-group-sm">
            ...
            <span class="am-input-group-btn" style="width: 30%;">
				        <a href="${basePath}/teacher/addTeacher"><button id="searchTeacher" class="am-btn am-btn-default" type="button">添加</button></a>
			</span>
          </div>
        </div>
      </div>
          ...
          <c:forEach items="${teacherList}" var="t" varStatus="s">
            <form name='form'>
              ...
              <tr>
                ...
                <td>${t.teacherId}</td>
                <td><a href='findAllTeachers?id=${t.teacherId}'>
                    ${t.teacherName }</a></td>
                <td>${t.majorId }</td>
                <td>${t.deptId}</td>
                <td>${t.role}</td>

                <td><a href="${basePath}/teacher/findTeacherByTeacherId/${t.teacherId}">修改</a>
                  <a onclick="return confirm('确定要删除吗？');" href="${basePath}/teacher/deleteTeacherById/${t.teacherId}">删除</a> </td>
<%--                <!-- 点击下载图片 -->--%>
