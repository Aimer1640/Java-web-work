...
public class ProjectController {
    ...
    @RequestMapping("/deleteProjectById/{projectId}")
    public String deleteProjectById(@PathVariable String projectId, HttpServletRequest request){
        int rows=projectMapper.deleteProjectById(projectId);
        String contextPath=request.getContextPath();
        return "redirect:/project/findAllProject";
    }

    @RequestMapping("/findProjectByProjectId/{projectId}")
    public String findProjectByProjectId(@PathVariable("projectId") String projectId,Model model){
