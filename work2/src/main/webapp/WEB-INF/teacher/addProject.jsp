        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-10 col-lg-11 center-column">
                    <form action="${basePath}/project/addProject" method="post" class="cmxform">
                        <div class="panel">
                            <div class="panel-heading">
                                <div class="panel-title">发布作业</div>
                                ...
                                <div class="col-md-7">
                                    <div class="form-group">
                                        <div class="input-group"> <span class="input-group-addon">作业ID</span>
                                            <input type="text" name="projectId" value="${p.projectId}" class="form-control">
                                        </div>
                                    </div>
